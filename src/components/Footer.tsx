          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-sky-800 hover:bg-sky-600 flex items-center justify-center transition-colors"
              >
                <svg
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-10 h-10 rounded-full bg-sky-800 hover:bg-red-600 flex items-center justify-center transition-colors"
              >
                <svg
                  className="w-5 h-5 text-white"
                  fill="currentColor"
