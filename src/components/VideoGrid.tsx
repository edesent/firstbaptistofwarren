      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {videos.map((video) => (
          <button
            ...
            className="group text-left bg-white rounded-2xl overflow-hidden shadow-sm hover:-translate-y-1 hover:shadow-xl transition-all cursor-pointer border border-sky-100"
          >
              ...
              <div className="absolute inset-0 bg-black/15 group-hover:bg-black/35 transition-colors flex items-center justify-center">
                <div className="w-16 h-16 rounded-full bg-white/95 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-7 h-7 text-sky-600 ml-1"
                  >
            ...
            <div className="p-5">
              <h4 className="font-semibold text-sky-900 mb-1 line-clamp-2 group-hover:text-sky-700 transition-colors">
                {video.title}
              </h4>
